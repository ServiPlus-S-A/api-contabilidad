# CLAUDE.md — api-contabilidad (Yummy Inc)

## Project
Accounting microservice for Yummy Inc. Manages cotizaciones (quotes), facturas (invoices),
...
- Current: V1__schema_inicial.sql (cotizaciones, lineas_cotizacion, facturas, lineas_factura, abonos, audit_log, contadores)
