...
const mockCotizacion: CotizacionResponse = {
  ...
  total: 226.00,
  lineas: [
    { id: 1, descripcion: 'Consultoría', cantidad: 2, precioUnitario: 100, subtotal: 200 },
  ],
...
test.describe('Cotizaciones', () => {
  ...
  test('el panel muestra botones aprobar/rechazar solo para cotizaciones ENVIADA', async ({ page }) => {
    // Arrange
